...
void student_management_menu(Catalog*& arr_of_menu);
void administration(Catalog*& arr_of_menu);
void news(Catalog*& arr_of_menu);
void contacts(Catalog*& arr_of_menu);
...
void showMenu_1(Catalog*& arr_of_menu)
{
    while (true)
    {
        ...
        switch (item) {
        case 7:
            student_management_menu(arr_of_menu);
            break;
        case 8:
            administration(arr_of_menu);
            break;
        case 9:
            news(arr_of_menu);
            break;
        case 10:
            contacts(arr_of_menu);
        case 11:
